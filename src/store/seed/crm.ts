...
export function seedCrm(): Partial<DB> {
  ...
  const leads: Lead[] = [
    ...
    lead('lead_07', 'Export brackets — Gulf', 'Al Noor Trading LLC', 'Qualified', 2100000, IDS.uPriya, 'Priya Mehta', { created: '2026-08-28', contactName: 'Faisal Rahman', email: 'faisal@alnoor.ae', phone: '+971 50 123 4567', city: 'Dubai', source: 'Partner', expectedClose: '2026-11-15', nextStep: 'Share LUT export price list in USD', notes: 'Route via Elixir Insights if incoterms require.' }),
