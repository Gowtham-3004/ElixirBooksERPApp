...
export const MicIcon = icon('M12 2a3 3 0 00-3 3v7a3 3 0 006 0V5a3 3 0 00-3-3z|M19 10v2a7 7 0 01-14 0v-2|M12 19v3|M8 22h8');
export const MicOffIcon = icon('M1 1l22 22|M9 9v3a3 3 0 005.12 2.12M15 9.34V5a3 3 0 00-5.94-.6|M17 16.95A7 7 0 015 12v-2m14 0v2a7 7 0 01-.11 1.23|M12 19v3|M8 22h8');
export const Volume2Icon = icon('M11 5L6 9H2v6h4l5 4V5z|M15.54 8.46a5 5 0 010 7.07|M19.07 4.93a10 10 0 010 14.14');
export const VolumeXIcon = icon('M11 5L6 9H2v6h4l5 4V5z|M23 9l-6 6|M17 9l6 6');
