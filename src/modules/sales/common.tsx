  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      ...
      <section>
        ...
        <LineItemGrid lines={doc.lines} readOnly currency={doc.currency} showTax={showTax} showWarehouse={showWarehouse} showBatch={showBatch} totals={doc.totals} extraColumns={lineExtraColumns} sourceLinked={sourceLinked} />
      </section>
