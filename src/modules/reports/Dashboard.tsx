            ...
            {data.byBranch.map((b, i) => {
              ...
              return (
                <div key={b.branch.id}>
                  ...
                  <div style={{ height: 6, background: 'var(--surface-3)', borderRadius: 9999 }}><div style={{ height: '100%', width: `${(b.revenue / max) * 100}%`, background: 'var(--accent)', borderRadius: 9999 }} /></div>
                </div>
              );
            })}
          </div>
