  ...
  return (
    <div className="page">
      ...
      <div className="grid-4">
        ...
        <KpiTile label="Overdue" value={<span style={{ color: data.exposure.overdue ? '#C0393F' : undefined }}>{fmtMoney(data.exposure.overdue)}</span>} sub={data.exposure.overdue ? 'Follow up under Collections' : 'Nothing overdue'} onClick={() => nav.go('sales/collections', { customer: c.id })} />
