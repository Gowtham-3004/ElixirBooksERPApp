  ...
  return (
    <div className="page">
      ...
      <div className="grid-4">
        <KpiTile label="Outstanding" amount={data.exposure.outstanding} sub={`${data.oi.filter((o) => o.direction === 'Debit').length} open invoices`} onClick={() => setTab('open')} />
        ...
        <KpiTile label="Sales this FY" amount={data.ytd} sub={data.dso ? `avg ${data.dso} days to pay` : `${data.inv.length} invoices`} />
      </div>
