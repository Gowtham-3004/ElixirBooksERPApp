...
export function BrandMark({ size = 36, light }: { size?: number; light?: boolean }) {
  return (
    <div style={{ width: size, height: size, borderRadius: size * 0.28, background: light ? 'rgba(255,255,255,0.2)' : 'var(--ink)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
